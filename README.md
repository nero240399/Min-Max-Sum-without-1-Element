...
## Result
Solve this problem with edge cases handled:
- Abnormal inputs: whitespaces, invalid, not only positive integers, only 1 number.
- Bonus cases: min, max, even ones, odd ones, sum.
